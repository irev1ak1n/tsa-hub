...
export const NATIONAL_TSA = [
    ...
    { img: facebookIcon, title: 'Official TSA Facebook', desc: 'Organization updates, photos, and community news.', url: 'https://www.facebook.com/nationalTSA/' },
...
const RESOURCE_KEYWORDS = {
    ...
    'dress code': 'attire clothing what to wear formal business competition attire conference attire shirt pants shoes tie outfit uniform what should i wear appropriate clothing dress',
    'code of conduct': 'behavior conduct discipline expectations rules honor social media policy',
    'packing checklist': 'what to bring pack packing luggage suitcase supplies essentials list bring items what should i pack what to pack conference packing list bring to conference',
    ...
    'safety and emergencies': 'safety emergency emergencies medical health security first aid evacuation help competition rules what if something happens medical emergency incident accident injury',
    ...
    'eligibility charts': 'eligibility eligible who can compete how many entries entry limits chapter entries maximum entries per chapter division limits how many students can compete',
    'preconference submissions': 'preconference pre conference pre-conference submission submissions submit deadline submission deadline submit before conference upload before conference due before conference files links required before arriving what do i submit before nationals',
    'state advisor approval events': 'advisor approval state advisor approval required advisor approved events which events need approval asterisk events events requiring approval',
    'national competition requirements': 'national requirements nationals requirements national conference requirements nationals checklist what do i need for nationals what do i need at nationals',
    'conference registration & attendance': 'registration attend conference conference attendance how to register attendance requirements badge chaperone required to attend',
